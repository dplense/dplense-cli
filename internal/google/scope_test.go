...
func TestResolveScope_Active(t *testing.T) {
	mockDir := newInlineDirectoryMock()
	mockDir.ListUsersFunc = func(ctx context.Context, suspended bool) ([]User, error) {
		return []User{
...
func TestResolveScope_User(t *testing.T) {
	mockDir := newInlineDirectoryMock()
	mockDir.GetUserFunc = func(ctx context.Context, email string) (*User, error) {
		return &User{
			ID:          "1",
			Email:       email,
...
func TestResolveScope_SharedDrives(t *testing.T) {
	...
	mockDrive.ListDrivesFunc = func(ctx context.Context, adminAccess bool) ([]Drive, error) {
		return []Drive{
